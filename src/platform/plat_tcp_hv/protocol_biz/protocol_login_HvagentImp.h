#ifndef IProtocolLoginHvAgentImp_H
#define IProtocolLoginHvAgentImp_H

#include "./protocol_biz/protocolLoginHvwork.h"
...
class TcpLoginHvAgent;

class  IProtocolLoginHvAgentImp : public QObject
{
    Q_OBJECT
public:
    static IProtocolLoginHvAgentImp* GetInstance();
    ~IProtocolLoginHvAgentImp();
...
private:
    IProtocolLoginHvAgentImp();
    static IProtocolLoginHvAgentImp* m_instance;
...
public:
  ...
  void InitTcpAgent(QString loginurl, QString port);
    ...
    ProtocolLoginHvWork* WorkObject();
...
private:
    ...
    ProtocolLoginHvWork*       m_pProtocolwork;

    TcpLoginHvAgent*           m_tcpAgent;
...
#endif // IProtocolLoginHvAgentImp_H
