#ifndef ProtocolLoginHvWork_H
#define ProtocolLoginHvWork_H
...
class IProtocolLoginHvAgentImp;

class ProtocolLoginHvWork : public QObject
{
    Q_OBJECT
...
public:
    ...
    void    Init();
    void    Protocol(IProtocolLoginHvAgentImp *imp);
    void    InitTimer();
    void    Clear();
...
private:
    ...
    IProtocolLoginHvAgentImp                 *m_protocol;
