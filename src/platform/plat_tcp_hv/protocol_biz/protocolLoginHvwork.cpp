...
ProtocolLoginHvWork::ProtocolLoginHvWork() : QObject()
{
...
ProtocolLoginHvWork::~ProtocolLoginHvWork()
{
}

void ProtocolLoginHvWork::Init()
{
...
void ProtocolLoginHvWork::onInitTimer()
{
    m_exitclose      = true;
...
void ProtocolLoginHvWork::Protocol(IProtocolLoginHvAgentImp *imp)
{
    m_protocol = imp;
}

void ProtocolLoginHvWork::InitTimer()
{

}

void ProtocolLoginHvWork::Clear()
{
}

void ProtocolLoginHvWork::SetUserState(EPRESENCESTATUS state)
{
...
void ProtocolLoginHvWork::R_UploadDumpFile()
{
    /*
...
void ProtocolLoginHvWork::R_OnParentHeartPaceTimeOut()
{
...
void ProtocolLoginHvWork::onReceiveCmdTask(QString cmd)
{
...
int ProtocolLoginHvWork::ParseProtocol(const QString &body, QString& req, QString& sender)
{
...
void ProtocolLoginHvWork::ReplyPrototcol(const QString& req, const QString &sender, const QString &receiver, int rescode)
{
...
void ProtocolLoginHvWork::R_ThreadInit()
{
