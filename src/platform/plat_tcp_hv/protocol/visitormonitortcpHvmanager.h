...
class  VisitorMonitorTcpHvManager : public Plat_MonitorTcpInterface
{
    Q_OBJECT

public:
    static VisitorMonitorTcpHvManager* Instance();
    ~VisitorMonitorTcpHvManager();

private:
    VisitorMonitorTcpHvManager();
    static VisitorMonitorTcpHvManager* m_instance;
...
#define gVisitorMonitorTcpHvManager VisitorMonitorTcpHvManager::Instance()
