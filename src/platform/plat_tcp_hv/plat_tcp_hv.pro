...
DEFINES += EL_PROJECTNAME=\\\"plat_tcp_hv\\\"
...
HEADERS += \
    plat_tcp_hv_global.h \
    plat_tcp_hv.h


TRANSLATIONS += \
    $$PWD/../../translations/plat_tcp_hv_en.ts
...
-L$$PWD/../../../third/hv/lib$$DEBUG_RELEASE -lhv
}
macx {
LIBS += -L$$DESTDIR -lplat_utils  -lutils_interface  -lel_common -lrunInterface  -lplatdata -lplat_interface  -lel_session -lhv
}
