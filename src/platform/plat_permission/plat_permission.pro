...
TEMPLATE = lib
DEFINES += PLAT_PERMISSION_LIBRARY
...
DEFINES += EL_PROJECTNAME=\\\"plat_permission\\\"
...
HEADERS += \
    plat_permission_global.h \
    plat_permission.h

TRANSLATIONS += \
    plat_permission_zh_CN.ts
...
macx {
LIBS += -L$$DESTDIR -lel_session -lplat_interface -lel_session  -lplat_utils  -lplatdata -lel_common
}
