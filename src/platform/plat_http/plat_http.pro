...
DEFINES += EL_PROJECTNAME=\\\"plat_http\\\"
...
include(plat_http.pri)
include(platclient/platclient.pri)
...
TRANSLATIONS += \
    $$PWD/../../translations/plat_http_en.ts
...
macx {
LIBS += -L$$DESTDIR -lplat_utils -lel_common  -lrunInterface  -lutils_interface -lplatdata  -lplat_interface
}
