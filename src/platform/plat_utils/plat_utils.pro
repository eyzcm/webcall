QT += core gui multimedia network xml webenginewidgets webchannel gui-private svg widgets

TEMPLATE = lib

DEFINES += PLAT_UTILS_LIBRARY
...
TRANSLATIONS += \
    $$PWD/../../translations/plat_utils_en.ts
