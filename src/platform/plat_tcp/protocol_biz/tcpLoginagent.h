#ifndef TcpLoginAgent_H
#define TcpLoginAgent_H
...
class TcpLoginAgent : public QObject
{
    Q_OBJECT

public:
    static TcpLoginAgent *GetInstance();
    ~TcpLoginAgent();

private:
    TcpLoginAgent();
    static TcpLoginAgent *m_instance;
...
#define gTcpLoginAgent TcpLoginAgent::GetInstance()

#endif // TcpLoginAgent_H
