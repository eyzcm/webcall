#ifndef VisitorMonitorLoginTcpAgent_H
#define VisitorMonitorLoginTcpAgent_H
...
class VisitorMonitorLoginTcpAgent : public ITcpWork
{
    Q_OBJECT

public:
    static VisitorMonitorLoginTcpAgent* GetInstance();
    ~VisitorMonitorLoginTcpAgent();

private:
    VisitorMonitorLoginTcpAgent();
    static VisitorMonitorLoginTcpAgent* m_instance;
...
#define gVisitorMonitorLoginTcpAgent VisitorMonitorLoginTcpAgent::GetInstance()

#endif // VisitorMonitorLoginTcpAgent_H
