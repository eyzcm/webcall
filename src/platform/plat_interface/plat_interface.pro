...
TEMPLATE = lib
DEFINES += PLAT_INTERFACE_LIBRARY
...
DEFINES += EL_PROJECTNAME=\\\"plat_interface\\\"
...
include(protocolInterface.pri)
include(dbInterface.pri)
include(serviceInterface/serviceinterface.pri)
include("datafactory/datafactory.pri")
...
HEADERS += \
    plat_interface_global.h \
    plat_interface.h


TRANSLATIONS += \
    $$PWD/../../translations/plat_interface_en.ts
...
macx {
LIBS += -L$$DESTDIR -lplat_utils -lel_common -lutils_interface -lrunInterface -lplatdata
}
