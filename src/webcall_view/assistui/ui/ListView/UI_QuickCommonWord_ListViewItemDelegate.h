...
class UI_QuickCommonWord_ListViewItemDelegate : public QStyledItemDelegate
{
    Q_OBJECT

public:
    UI_QuickCommonWord_ListViewItemDelegate(QObject *parent = nullptr);
    ~UI_QuickCommonWord_ListViewItemDelegate();
