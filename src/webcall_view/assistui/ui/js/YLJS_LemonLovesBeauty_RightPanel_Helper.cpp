#include "YLJS_LemonLovesBeauty_RightPanel_Helper.h"
...
YLJS_LemonLovesBeauty_RightPanel_Helper::YLJS_LemonLovesBeauty_RightPanel_Helper() : BaseJsCommonHelper()
{
...
YLJS_LemonLovesBeauty_RightPanel_Helper::~YLJS_LemonLovesBeauty_RightPanel_Helper()
{
}

void YLJS_LemonLovesBeauty_RightPanel_Helper::SetUrl(const QString& url)
{
    if (GetCurrentView())
    {
...
void YLJS_LemonLovesBeauty_RightPanel_Helper::SetInitData()
{
    if (GetCurrentView())
    {
        Json::Value val;
...
void YLJS_LemonLovesBeauty_RightPanel_Helper::R_ProjectLinks_Checked(QString databody, QString links)
{
    Q_EMIT S_ProjectLinks_Checked(databody, links);
}
