#ifndef UIYL_ManRobotRuleSearchResultListViewModel_H
#define UIYL_ManRobotRuleSearchResultListViewModel_H
...
class UIYL_ManRobotRuleSearchResultListViewModel : public QAbstractItemModel
{
    Q_OBJECT

public:
    explicit UIYL_ManRobotRuleSearchResultListViewModel(QStringList headers, QObject *parent = 0);
    ~UIYL_ManRobotRuleSearchResultListViewModel();
...
#endif // UIYL_ManRobotRuleSearchResultListViewModel_H
