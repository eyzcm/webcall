...
class UIYL_ManRobotRuleSearchResultListViewItemDelegate : public QStyledItemDelegate
{
    Q_OBJECT

public:
    UIYL_ManRobotRuleSearchResultListViewItemDelegate(QObject *parent = nullptr);
    ~UIYL_ManRobotRuleSearchResultListViewItemDelegate();
