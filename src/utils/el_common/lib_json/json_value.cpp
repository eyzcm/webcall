...
namespace Json
{
    ...
    const ULONG64  Value::maxULong = ULONG64(-1);
...
// //////////////////////////////////////////////////////////////////
    ...
    Value::Value(ULONG64 value)
        : type_(ulongValue), comments_(0)
#ifdef JSON_VALUE_USE_INTERNAL_MAP
          ,
          itemIsUsed_(0)
#endif
    ...
    Value::Int Value::asInt() const
    {
        switch (type_)
        {
            ...
            case ulongValue:
                JSON_ASSERT_MESSAGE(value_.ulong_ >= minInt && value_.real_ <= maxInt, "ulong out of signed integer range");
                return Int(value_.real_);
            case booleanValue:
    ...
    Value::UInt Value::asUInt() const
    {
        switch (type_)
        {
            ...
            case uintValue:
                return value_.uint_;
            case ulongValue:
                JSON_ASSERT_MESSAGE(value_.ulong_ >= 0 && value_.ulong_ <= maxUInt, "ulong out of unsigned integer range");
    ...
    bool Value::isConvertibleTo(ValueType other) const
    {
        switch (type_)
        {
            case nullValue:
                return true;
            case intValue:
                return (other == nullValue && value_.int_ == 0) || other == intValue || (other == uintValue && value_.int_ >= 0) || other == ulongValue || other == realValue || other == stringValue || other == booleanValue;
            case uintValue:
                return (other == nullValue && value_.uint_ == 0) || (other == intValue && value_.uint_ <= (unsigned)maxInt) || other == uintValue || other == ulongValue || other == realValue || other == stringValue || other == booleanValue;
            case realValue:
                return (other == nullValue && value_.real_ == 0.0) || (other == intValue && value_.real_ >= minInt && value_.real_ <= maxInt) || (other == uintValue && value_.real_ >= 0 && value_.real_ <= maxUInt) || (other == ulongValue && value_.real_ >= 0 && value_.real_ <= maxUInt)
                       || other == realValue || other == stringValue || other == booleanValue;
            case ulongValue:
                return (other == nullValue && value_.ulong_ == 0) || (other == ulongValue && value_.ulong_ <= (unsigned)maxULong) || other == uintValue || other == ulongValue || other == realValue || other == stringValue || other == booleanValue;

            case booleanValue:
                return (other == nullValue && value_.bool_ == false) || other == intValue || other == uintValue || other == ulongValue || other == realValue || other == stringValue || other == booleanValue;
            case stringValue:
